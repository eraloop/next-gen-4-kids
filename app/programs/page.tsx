  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <PageHero 
        ...
        title="The Academy: Structured for <span class='text-sky font-playful lowercase tracking-normal italic'>Mastery.</span>"
      ...
      <AnimatedSection className="bg-white">
        <div className="editorial-container space-y-24 md:space-y-32">
          <div className="max-w-4xl space-y-12">
            ...
            <h2 className="text-4xl md:text-7xl font-semibold tracking-tighter uppercase text-balance">Pathways of <br /><span className="opacity-30">Discovery & </span><span className="text-highlight font-playful lowercase tracking-normal italic">Defense.</span></h2>
          </div>
            ...
            {programs.map((p, i) => (
              <Card key={i} className={cn(
                ...
                <Button variant="outline" className={cn(
                  "w-full h-16 transition-all duration-500 font-semibold mt-12", 
        ...
        <div className="editorial-container space-y-20 md:space-y-32">
           <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-20 md:gap-32 items-start">
              <div className="space-y-12 lg:sticky lg:top-32">
                 ...
                 <h2 className="text-4xl md:text-6xl font-semibold tracking-tighter uppercase leading-[0.9] text-balance">Empowering the <br /><span className="text-leaf font-playful lowercase tracking-normal italic">Mentors.</span></h2>
                 <p className="text-lg md:text-xl font-light text-muted-foreground leading-relaxed text-balance">
                   We provide schools and institutional partners with the pedagogical frameworks and technical manuals needed to sustain a world-class STEM environment.
                 </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                 {educatorGuides.map((guide, i) => (
                   <Card key={i} className={cn(
                      ...
                      <Button variant="link" className={cn("p-0 h-auto justify-start transition-colors font-semibold", guide.highlight ? "text-white" : "text-black/40 group-hover:text-white")}>Download Guide</Button>
                   </Card>
                 ))}
                 <Card className="bg-sun text-black border-none flex flex-col justify-between space-y-12 min-h-[350px] h-full shadow-xl shadow-sun/5 group transition-all duration-700 hover:bg-black hover:text-white">
                    <div className="flex justify-between items-start">
                       <h3 className="text-2xl md:text-3xl font-semibold tracking-tight uppercase leading-[1.1] transition-colors duration-500 group-hover:text-white">Custom <br />Partnership.</h3>
                    ...
                    <Button variant="outline" className="border-black text-black group-hover:border-white group-hover:text-white hover:bg-white hover:text-black font-semibold transition-all duration-500">Inquire Now</Button>
                 </Card>
              </div>
           </div>
        </div>
      ...
      <AnimatedSection className="bg-white">
         <div className="editorial-container bg-black text-white p-12 md:p-24 flex flex-col md:flex-row justify-between items-center gap-12">
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tighter uppercase text-center md:text-left text-balance">Access the <span className="text-sun font-playful lowercase tracking-normal italic">Digital Library.</span></h2>
            <Button variant="sun" size="lg" className="w-full md:w-auto flex items-center gap-4 shadow-xl shadow-sun/10">Browse Resources <ArrowRight className="w-5 h-5" /></Button>
         </div>
      </AnimatedSection>
    </div>
  );
